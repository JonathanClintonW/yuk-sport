...
<body class="font-poppins overflow-y-scroll no-scrollbar scroll-smooth">
    <div id="app">
        <nav
            ...
            <ul class="hidden absolut font-bold  lg:flex lg:items-center lg:w-auto lg:space-x-6">
                <li
                    class="{{ Route::currentRouteName() === 'destination' ? 'custom-gradient-bg px-2 py-0.5 text-text-light rounded-lg shadow-gray-500 shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1)]' : '' }}">
