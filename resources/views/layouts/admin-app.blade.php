    ...
    <div id="app">
        <div>
            <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar"
                ...
                class="inline-flex items-center p-2 mt-2 ml-3 text-sm  rounded-lg sm:hidden focus:outline-none focus:ring-2  text-gray-400 hover:bg-dark-primary-color focus:ring-gray-600">
                    ...
                    <ul class="space-y-2 font-medium">
                        ...
                        <li class="mb-3">
                            <a href="{{ route('admin.list') }}"
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap text-sm">LAPANGAN</span>
                            </a>
                        </li>
                        ...
                        <li class="mb-3">
                            <a href="{{ route('admin.manage') }}"
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap text-sm">MANAGE</span>
                            </a>
                        </li>
                        ...
                        <li class="mb-3">
                            <a href="{{ route('admin.add') }}"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                  ...
                                  <span class="flex-1 ml-3 whitespace-nowrap text-sm">TAMBAH</span>
                            </a>
                        </li>
