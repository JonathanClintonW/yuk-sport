            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex justify-between items-center mx-1.5 mb-20px">
                    ...
                    <input id="email" type="email"
                        class="px-2.5 py-0.5 border-1 border-primary-color hover:shadow-sm focus:shadow-sm focus:border-secondary-color focus:ring-0 rounded-lg dark:text-text-light bg-transparent"
