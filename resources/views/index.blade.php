...
@section('content')
    ...
    <div class="max-w-screen">
        <div class="flex flex-col max-w-screen-xl mx-auto md:flex-row justify-evenly items-center md:items-start select-none mt-2 mb-5 ">
            <div class="mb-4">
                <h2 class="dark:text-text-light text-base sm:text-xl font-semibold transition-all duration-200">Why choose
                    us?</h2>
            </div>
            <article class="flex flex-col justify-items-center w-2/5">
                <h1
                ...
                <p class="font-medium text-sm text-left text-text-dark-gray dark:text-text-gray">With a collection of destinations that include
    ...
    <div class="sm:mb-5 w-screen grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-items-center items-center select-none">
        <div class="w-52 h-44 mb-5 px-3 py-2 dark:bg-dark-secondary-bg rounded-xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#9D4CCC" class="w-8 h-8 mb-2">
            ...
            <p class="mb-1 text-sm font-semibold text-text-dark-gray/[.75] dark:text-text-gray">Thousands of the best destinations are ready to spoil your eyes.</p>
        </div>
        <div class="w-52 h-44 mb-5 px-3 py-2 dark:bg-dark-secondary-bg rounded-xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#9D4CCC" class="w-8 h-8 mb-2">
            ...
            <p class="mb-1 text-sm font-semibold text-text-dark-gray/[.75] dark:text-text-gray">No need to be complicated in ordering tickets, order now with a few taps.</p>
        </div>
        <div class="w-52 h-44 mb-5 px-3 py-2 dark:bg-dark-secondary-bg rounded-xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#9D4CCC" class="w-8 h-8 mb-2">
            ...
            <p class="mb-1 text-sm font-semibold text-text-dark-gray/[.75] dark:text-text-gray">There are many choices of interesting destinations to make stories on your trip.</p>
        </div>
        <div class="w-52 h-44 mb-5 px-3 py-2 dark:bg-dark-secondary-bg rounded-xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#9D4CCC" class="w-6 h-6">
            ...
            <p class="mb-1 text-sm font-semibold text-text-dark-gray/[.75] dark:text-text-gray">Don't worry about traveling anywhere, our tour guide is ready to guide you anytime.</p>
        </div>
    </div>
        ...
        <div class="w-[450px]">
            <section class="flex">
                ...
                <article class="ml-3 mb-3">
                    ...
                    <p class="text-text-dark-gray dark:text-text-gray text-sm font-medium break-words">Find your dream
            ...
            <section class="flex">
                ...
                <article class="ml-3 mb-3">
                    ...
                    <p class="text-text-dark-gray dark:text-text-gray text-sm font-medium break-words">After you find the
            ...
            <section class="flex">
                ...
                <article class="ml-3 mb-3">
                    ...
                    <p class="text-text-dark-gray dark:text-text-gray text-sm font-medium break-words">After you pay, you
    ...
    <div>
        <div class="flex flex-col justify-center align-center items-center w-screen select-none">
            <div>
                <h1
