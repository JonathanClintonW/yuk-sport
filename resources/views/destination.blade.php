...
@section('content')
    <div class="mt-20 flex flex-col items-center select-none pb-4">
        <section class="flex flex-col items-center">
            ...
            <p class="mb-7 w-64 sm:w-[30rem] md:w-[40rem] text-sm text-justify sm:text-base transition-all duration-200 dark:text-text-gray">Explore the allure of Bali's sun-kissed beaches, the timeless beauty of Japan's cultural treasures, and the
