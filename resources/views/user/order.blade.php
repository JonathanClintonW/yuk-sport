...
@section('content')
    <div class="min-h-screen flex align-center items-center">
        ...
        <section class="pb-5 flex flex-col items-center w-screen dark:bg-dark-primary-bg">
            <div
                ...
                <form action="{{ route('order.create') }}" method="post" class="flex flex-col" enctype="multipart/form-data"
                    ...
                    <hr class="w-48 h-1 mx-auto mb-3 bg-black border-0 rounded">
