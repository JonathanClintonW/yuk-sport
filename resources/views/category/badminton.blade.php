...
@section('content')
    <div class="relative">
        <div class="flex items-center justify-center h-[40rem] bg-fixed bg-center bg-cover -translate-y-[48px]"
            style="background-image: url('{{ asset('images/badminton-main.jpg') }}'); background-size: cover;">
            <h1
    ...
    <div class="flex flex-col items-center min-h-screen select-none">
        <h2
            ...
            Lapangan Badminton</h2>
        <div>
            @if ($badmintonlapangan->isEmpty())
                <div>
            ...
            @else
                <div
                    ...
                    @foreach ($badmintonlapangan as $lapangan)
                        <div
